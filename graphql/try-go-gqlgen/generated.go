...
type TodoResolver interface {
	User(ctx context.Context, obj *models.Todo) (models.UserImpl, error)
}
...
// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _User(ctx context.Context, sel ast.SelectionSet, obj *models.UserImpl) graphql.Marshaler {
